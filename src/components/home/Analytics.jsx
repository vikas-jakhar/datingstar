    ...
    return (
        <div className='lg:py-24 py-10 sm:py-16 relative'>
            <div className="container xl:pt-24 mt-1 relative z-[1]">
                ...
                <div className="pt-9 flex flex-wrap -mx-3 justify-center flex-row">
                    {ANALYTICS_DATA.map((i, index) => (
                        <Tilt key={index} className='lg:w-4/12 sm:w-6/12 justify-center' options={tiltOptions}>
                            <div data-aos="zoom-in" className="w-full justify-center flex xl:px-3 px-2 mt-4 xl:mt-6">
                                <div className="rounded-[22px] group border border-light-gray max-w-[364px] sm:max-w-full min-h-[248px] hover:border-off-yellow transition_slow bg-off-white w-full h-full p-5 transform transition-transform duration-500 ease-in-out hover:scale-[1.05] shadow-lg hover:shadow-2xl">
