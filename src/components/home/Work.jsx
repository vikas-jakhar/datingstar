            ...
            <div className="container my-1.5 relative z-[1]">
                <div className="flex flex-col lg:flex-row gap-7 items-center justify-between">
                    <div className="max-w-[474px] w-full flex flex-col items-center lg:items-start">
                        ...
                        <p data-aos="zoom-in" className='mt-10 text-white text-center lg:text-left font-raleway text-2xl font-semibold'>Get in touch</p>
                    ...
                    <div data-aos="zoom-in" className="max-w-[565px] min-h-[538px] items-center p-6 flex justify-center w-full bg-form-layer bg-no-repeat bg-100">
